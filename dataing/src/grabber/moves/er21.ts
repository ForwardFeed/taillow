import { PProcessorData, cPreprocessFileNest2 } from "../../c_parser/preprocessor"
...
import { ERMove, ERMoveFlags, ERMoveFlagsBan, initErMove, Move, MoveFlags } from "./types"



type Moves = Map<string, ERMove>
