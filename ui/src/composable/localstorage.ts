...
export interface StorageUtils {
    ...
    getItem: (key: string, ifFailed: string | undefined) => string 
    setItem: (key: string, value: string, retryAfterClear: boolean) => void
...
export function useLocalStorage(APP_NAME: string): StorageUtils{
    ...
    return {
        ...
        setItem(key, value, retryAfterClear=false) {
